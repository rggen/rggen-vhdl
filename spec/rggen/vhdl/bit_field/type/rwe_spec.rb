  ...
  context '参照ビットフィールドを持たない場合' do
    it '入力ポート#controlを持つ' do
      expect(bit_fields[0]).to have_port(
        ...
        name: 'i_register_0_bit_field_0_enable', direction: :in, width: 1
      )
      expect(bit_fields[2]).to have_port(
        :register_block, :control,
        name: 'i_register_0_bit_field_2_enable', direction: :in, width: 1
      )
      expect(bit_fields[4]).to have_port(
        :register_block, :control,
        name: 'i_register_0_bit_field_4_enable', direction: :in, width: 1, array_size: [2]
      )

      expect(bit_fields[6]).to have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_0_enable', direction: :in, width: 1, array_size: [4]
      )
      expect(bit_fields[8]).to have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_2_enable', direction: :in, width: 1, array_size: [4]
      )
      expect(bit_fields[10]).to have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_4_enable', direction: :in, width: 1, array_size: [4, 2]
      )

      expect(bit_fields[12]).to have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_0_enable', direction: :in, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[14]).to have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_2_enable', direction: :in, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[16]).to have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_4_enable', direction: :in, width: 1, array_size: [2, 2, 2]
      )

      expect(bit_fields[19]).to have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_0_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[21]).to have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_2_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[23]).to have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_4_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2, 2]
      )
    end
  end
  ...
  context '参照ビットフィールドを持つ場合' do
    it '入力ポート#controlを持たない' do
      expect(bit_fields[1]).to not_have_port(
        :register_block, :control,
        name: 'i_register_0_bit_field_1_enable', direction: :in, width: 1
      )
      expect(bit_fields[3]).to not_have_port(
        :register_block, :control,
        name: 'i_register_0_bit_field_3_enable', direction: :in, width: 1
      )
      expect(bit_fields[5]).to not_have_port(
        :register_block, :control,
        name: 'i_register_0_bit_field_5_enable', direction: :in, width: 1, array_size: [2]
      )

      expect(bit_fields[7]).to not_have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_1_enable', direction: :in, width: 1, array_size: [4]
      )
      expect(bit_fields[9]).to not_have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_3_enable', direction: :in, width: 1, array_size: [4]
      )
      expect(bit_fields[11]).to not_have_port(
        :register_block, :control,
        name: 'i_register_1_bit_field_5_enable', direction: :in, width: 1, array_size: [4, 2]
      )

      expect(bit_fields[13]).to not_have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_1_enable', direction: :in, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[15]).to not_have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_3_enable', direction: :in, width: 1, array_size: [2, 2]
      )
      expect(bit_fields[17]).to not_have_port(
        :register_block, :control,
        name: 'i_register_2_bit_field_5_enable', direction: :in, width: 1, array_size: [2, 2, 2]
      )

      expect(bit_fields[18]).to not_have_port(
        :register_block, :control,
        name: 'o_register_3_bit_field_0_enable', direction: :in, width: 1
      )

      expect(bit_fields[20]).to not_have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_1_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[22]).to not_have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_3_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2]
      )
      expect(bit_fields[24]).to not_have_port(
        :register_block, :control,
        name: 'i_register_file_4_register_file_0_register_0_bit_field_5_enable', direction: :in, width: 1, array_size: [2, 2, 2, 2, 2]
      )
    end
  end
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_read_valid   => bit_field_read_valid,
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => i_register_0_bit_field_4_enable(1*(i)+0 downto 1*(i)),
      ...
      expect(bit_fields[10]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_read_valid   => bit_field_read_valid,
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => i_register_1_bit_field_4_enable(1*(2*i+j)+0 downto 1*(2*i+j)),
      ...
      expect(bit_fields[16]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_read_valid   => bit_field_read_valid,
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => i_register_2_bit_field_4_enable(1*(4*i+2*j+k)+0 downto 1*(4*i+2*j+k)),
      ...
      expect(bit_fields[23]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_read_valid   => bit_field_read_valid,
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => i_register_file_4_register_file_0_register_0_bit_field_4_enable(1*(16*i+8*j+4*k+2*l+m)+0 downto 1*(16*i+8*j+4*k+2*l+m)),
