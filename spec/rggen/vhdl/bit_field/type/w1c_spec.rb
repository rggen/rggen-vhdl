        ...
        register_file do
          ...
          register_file do
            ...
            register do
              ...
              size [2, 2]
              bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :w1c; initial_value 0 }
              bit_field { name 'bit_field_1'; bit_assignment lsb: 4, width: 4, sequence_size: 4, step: 8; type :w1c; reference 'register_file_7.register_file_0.register_0.bit_field_0'; initial_value 0 }
            end
          end
        end
      ...
      expect(bit_fields[6]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+8*i+3 downto 4+8*i),
      ...
      expect(bit_fields[8]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+8*j+3 downto 4+8*j),
      ...
      expect(bit_fields[10]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+8*k+3 downto 4+8*k),
      ...
      expect(bit_fields[12]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+8*m+3 downto 4+8*m),
            ...
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => register_value(64*(28+2*i+j)+8+3 downto 64*(28+2*i+j)+8),
