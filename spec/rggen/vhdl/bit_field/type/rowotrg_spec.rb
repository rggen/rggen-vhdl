...
RSpec.describe 'bit_field/type/rowotrg' do
  ...
  it '出力ポート#value_out/#write_trigger/#read_triggerを持つ' do
    ...
    expect(bit_fields[0]).to have_port(
      ...
      name: 'o_register_0_bit_field_0_write_trigger', direction: :out, width: 1
    )
    expect(bit_fields[0]).to have_port(
    ...
    expect(bit_fields[1]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_0_bit_field_1_write_trigger', direction: :out, width: 1
    )
    expect(bit_fields[1]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[2]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_0_bit_field_2_write_trigger', direction: :out, width: 1, array_size: [2]
    )
    expect(bit_fields[2]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[3]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_1_bit_field_0_write_trigger', direction: :out, width: 1
    )
    expect(bit_fields[3]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[4]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_0_write_trigger', direction: :out, width: 1, array_size: [4]
    )
    expect(bit_fields[4]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[5]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_1_write_trigger', direction: :out, width: 1, array_size: [4]
    )
    expect(bit_fields[5]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[6]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_2_bit_field_2_write_trigger', direction: :out, width: 1, array_size: [4, 2]
    )
    expect(bit_fields[6]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[7]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_0_write_trigger', direction: :out, width: 1, array_size: [2, 2]
    )
    expect(bit_fields[7]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[8]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_1_write_trigger', direction: :out, width: 1, array_size: [2, 2]
    )
    expect(bit_fields[8]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[9]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_3_bit_field_2_write_trigger', direction: :out, width: 1, array_size: [2, 2, 2]
    )
    expect(bit_fields[9]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[10]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_0_write_trigger', direction: :out, width: 1, array_size: [2, 2, 2, 2]
    )
    expect(bit_fields[10]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[11]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_1_write_trigger', direction: :out, width: 1, array_size: [2, 2, 2, 2]
    )
    expect(bit_fields[11]).to have_port(
      :register_block, :read_trigger,
    ...
    expect(bit_fields[12]).to have_port(
      :register_block, :write_trigger,
      name: 'o_register_file_4_register_file_0_register_0_bit_field_2_write_trigger', direction: :out, width: 1, array_size: [2, 2, 2, 2, 2]
    )
    expect(bit_fields[12]).to have_port(
      :register_block, :read_trigger,
      ...
      expect(bit_fields[3]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(23 downto 16),
      ...
      expect(bit_fields[7]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(0+16*i+3 downto 0+16*i),
            ...
            o_write_trigger   => o_register_3_bit_field_0_write_trigger(1*(i)+0 downto 1*(i)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_3_bit_field_0(4*(i)+3 downto 4*(i)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[8]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+16*i+3 downto 4+16*i),
            ...
            o_write_trigger   => o_register_3_bit_field_1_write_trigger(1*(i)+0 downto 1*(i)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_3_bit_field_1(4*(i)+3 downto 4*(i)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[9]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(8+16*i+3 downto 8+16*i),
            ...
            o_write_trigger   => o_register_3_bit_field_2_write_trigger(1*(i)+0 downto 1*(i)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_3_bit_field_2(4*(i)+3 downto 4*(i)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[12]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(0+16*j+3 downto 0+16*j),
            ...
            o_write_trigger   => o_register_5_bit_field_0_write_trigger(1*(2*i+j)+0 downto 1*(2*i+j)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_5_bit_field_0(4*(2*i+j)+3 downto 4*(2*i+j)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[13]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+16*j+3 downto 4+16*j),
            ...
            o_write_trigger   => o_register_5_bit_field_1_write_trigger(1*(2*i+j)+0 downto 1*(2*i+j)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_5_bit_field_1(4*(2*i+j)+3 downto 4*(2*i+j)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[14]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(8+16*j+3 downto 8+16*j),
            ...
            o_write_trigger   => o_register_5_bit_field_2_write_trigger(1*(2*i+j)+0 downto 1*(2*i+j)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_5_bit_field_2(4*(2*i+j)+3 downto 4*(2*i+j)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[17]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(0+16*k+3 downto 0+16*k),
            ...
            o_write_trigger   => o_register_8_bit_field_0_write_trigger(1*(4*i+2*j+k)+0 downto 1*(4*i+2*j+k)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_8_bit_field_0(4*(4*i+2*j+k)+3 downto 4*(4*i+2*j+k)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[18]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+16*k+3 downto 4+16*k),
            ...
            o_write_trigger   => o_register_8_bit_field_1_write_trigger(1*(4*i+2*j+k)+0 downto 1*(4*i+2*j+k)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_8_bit_field_1(4*(4*i+2*j+k)+3 downto 4*(4*i+2*j+k)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[19]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(8+16*k+3 downto 8+16*k),
            ...
            o_write_trigger   => o_register_8_bit_field_2_write_trigger(1*(4*i+2*j+k)+0 downto 1*(4*i+2*j+k)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_8_bit_field_2(4*(4*i+2*j+k)+3 downto 4*(4*i+2*j+k)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[22]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(0+16*m+3 downto 0+16*m),
            ...
            o_write_trigger   => o_register_file_11_register_file_0_register_0_bit_field_0_write_trigger(1*(16*i+8*j+4*k+2*l+m)+0 downto 1*(16*i+8*j+4*k+2*l+m)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_file_11_register_file_0_register_0_bit_field_0(4*(16*i+8*j+4*k+2*l+m)+3 downto 4*(16*i+8*j+4*k+2*l+m)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[23]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(4+16*m+3 downto 4+16*m),
            ...
            o_write_trigger   => o_register_file_11_register_file_0_register_0_bit_field_1_write_trigger(1*(16*i+8*j+4*k+2*l+m)+0 downto 1*(16*i+8*j+4*k+2*l+m)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_file_11_register_file_0_register_0_bit_field_1(4*(16*i+8*j+4*k+2*l+m)+3 downto 4*(16*i+8*j+4*k+2*l+m)),
            o_value_unmasked  => open
          );
      CODE
      ...
      expect(bit_fields[24]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_sw_write_valid  => bit_field_write_valid,
            i_sw_write_enable => "1",
            i_sw_mask         => bit_field_mask(8+16*m+3 downto 8+16*m),
            ...
            o_write_trigger   => o_register_file_11_register_file_0_register_0_bit_field_2_write_trigger(1*(16*i+8*j+4*k+2*l+m)+0 downto 1*(16*i+8*j+4*k+2*l+m)),
            ...
            i_mask            => (others => '1'),
            o_value           => o_register_file_11_register_file_0_register_0_bit_field_2(4*(16*i+8*j+4*k+2*l+m)+3 downto 4*(16*i+8*j+4*k+2*l+m)),
            o_value_unmasked  => open
          );
      CODE
    end
