        ...
        register_file do
          ...
          register_file do
            ...
            register do
              ...
              size [2, 2]
              bit_field { name 'bit_field_0'; bit_assignment lsb: 0, width: 4, sequence_size: 4, step: 8; type :w0c; initial_value 0 }
              bit_field { name 'bit_field_1'; bit_assignment lsb: 4, width: 4, sequence_size: 4, step: 8; type :w0c; reference 'register_file_7.register_file_0.register_0.bit_field_0'; initial_value 0 }
            end
          end
        end
