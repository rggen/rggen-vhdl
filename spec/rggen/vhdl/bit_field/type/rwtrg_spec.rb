      ...
      expect(bit_fields[3]).to generate_code(:bit_field, :top_down, <<~'CODE')
        u_bit_field: entity work.rggen_bit_field
          ...
          port map (
            ...
            o_write_trigger   => o_register_2_bit_field_0_write_trigger(1*(i)+0 downto 1*(i)),
            o_read_trigger    => o_register_2_bit_field_0_read_trigger(1*(i)+0 downto 1*(i)),
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => (others => '0'),
            i_hw_clear        => (others => '0'),
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~'CODE')
        u_bit_field: entity work.rggen_bit_field
          ...
          port map (
            ...
            o_write_trigger   => o_register_3_bit_field_0_write_trigger(1*(4*i+j)+0 downto 1*(4*i+j)),
            o_read_trigger    => o_register_3_bit_field_0_read_trigger(1*(4*i+j)+0 downto 1*(4*i+j)),
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => (others => '0'),
            i_hw_clear        => (others => '0'),
      ...
      expect(bit_fields[5]).to generate_code(:bit_field, :top_down, <<~'CODE')
        u_bit_field: entity work.rggen_bit_field
          ...
          port map (
            ...
            o_write_trigger   => o_register_4_bit_field_0_write_trigger(1*(8*i+4*j+k)+0 downto 1*(8*i+4*j+k)),
            o_read_trigger    => o_register_4_bit_field_0_read_trigger(1*(8*i+4*j+k)+0 downto 1*(8*i+4*j+k)),
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => (others => '0'),
            i_hw_clear        => (others => '0'),
      ...
      expect(bit_fields[6]).to generate_code(:bit_field, :top_down, <<~'CODE')
        u_bit_field: entity work.rggen_bit_field
          ...
          port map (
            ...
            o_write_trigger   => o_register_file_5_register_file_0_register_0_bit_field_0_write_trigger(1*(32*i+16*j+8*k+4*l+m)+0 downto 1*(32*i+16*j+8*k+4*l+m)),
            o_read_trigger    => o_register_file_5_register_file_0_register_0_bit_field_0_read_trigger(1*(32*i+16*j+8*k+4*l+m)+0 downto 1*(32*i+16*j+8*k+4*l+m)),
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => (others => '0'),
            i_hw_clear        => (others => '0'),
