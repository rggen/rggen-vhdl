      ...
      expect(bit_fields[1]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => register_value(800 downto 800),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
      ...
      expect(bit_fields[4]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => i_register_0_bit_field_4_set(1*(i)+0 downto 1*(i)),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
      ...
      expect(bit_fields[10]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => i_register_1_bit_field_4_set(1*(2*i+j)+0 downto 1*(2*i+j)),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
      ...
      expect(bit_fields[16]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => i_register_2_bit_field_4_set(1*(4*i+2*j+k)+0 downto 1*(4*i+2*j+k)),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
      ...
      expect(bit_fields[22]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => i_register_file_3_register_file_0_register_0_bit_field_4_set(1*(16*i+8*j+4*k+2*l+m)+0 downto 1*(16*i+8*j+4*k+2*l+m)),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
      ...
      expect(bit_fields[23]).to generate_code(:bit_field, :top_down, <<~"CODE")
        u_bit_field: entity #{library_name}.rggen_bit_field
          ...
          port map (
            ...
            i_hw_write_enable => "0",
            i_hw_write_data   => (others => '0'),
            i_hw_set          => register_value(32*(26+2*i+j)+0+0 downto 32*(26+2*i+j)+0),
            i_hw_clear        => (others => '0'),
            i_value           => (others => '0'),
            i_mask            => (others => '1'),
