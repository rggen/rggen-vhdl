          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(16+1*i+0 downto 16+1*i),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(20+2*i+1 downto 20+2*i),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(24+4*i+1 downto 24+4*i),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(16+1*j+0 downto 16+1*j),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(20+2*j+1 downto 20+2*j),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(24+4*j+1 downto 24+4*j),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(16+1*k+0 downto 16+1*k),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(20+2*k+1 downto 20+2*k),
          ...
          begin
            u_bit_field: entity work.rggen_bit_field
              ...
              port map (
                ...
                i_sw_write_valid  => bit_field_write_valid,
                i_sw_write_enable => "1",
                i_sw_mask         => bit_field_mask(24+4*k+1 downto 24+4*k),
